'use client'
import { sendResetPasswordEmail } from "@/lib/services/forgetPassword.service";
...
export default function Forgetpassword() {
  ...
  async function handleSubmitForm(values: { email: string }) {
    setLoading(true);
      ...
      <div className="max-w-lg mx-auto  bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form action="" className="my-10" onSubmit={handleSubmit(handleSubmitForm)} >
          <div className="flex flex-col space-y-5">
            ...
            <p className="text-center">Not registered yet? <Link href="/register" className="text-blue-500 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span>
            </span></Link></p>
          </div>
        </form>
      </div>
